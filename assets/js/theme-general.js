class Loader {
  ...
  class Slider {
    ...
    setOptions() {
      ...
      this.slideData = {
        0: {
          image: 'https://3meuy52x1q093zqwse2e3x0v-wpengine.netdna-ssl.com/wp-content/uploads/2019/12/angles_dining_chair_sentient_solid_wood_1-1-scaled.jpg',
          title: 'Sexiest',
          description: `Custom designed by and for Cal students with the aim to make the most stylish and comfortable chair possible. Imagine chairs 20 years in the future, this is it.` },
  
        1: {
          image: 'https://3meuy52x1q093zqwse2e3x0v-wpengine.netdna-ssl.com/wp-content/uploads/2019/12/angles_dining_chair_sentient_solid_wood_2-1-scaled.jpg',
          title: 'Hypest',
          description: `A limited edition chair with only 150 pieces. Leave behind the greatest school legacy. Have your name forever recorded on this website and your purchase number hand-engraved on your chair.` },
  
        2: {
          image: 'https://3meuy52x1q093zqwse2e3x0v-wpengine.netdna-ssl.com/wp-content/uploads/2020/03/IMG_5293-scaled.jpg',
          title: 'Coolest',
          description: `Style, comfort, innovation, and hype combine to birth the only chair worthy of carrying a Cal student. Tune in to Berkeley Chair Zen Space to be inspired by the great things us bears have achieved on our chairs and otherwise.` } };
